...
from Baleen.teams.backend_detect import BackendDetectionError, detect_backend
from Baleen.teams.mailbox import Mailbox, create_message
...
from Baleen.teams.progress import TeammateProgress
from Baleen.teams.registry import AgentNameRegistry
from Baleen.teams.shared_task import SharedTaskStore
from Baleen.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from Baleen.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
