...
PROJECT_AGENTS_DIR = ".Baleen/agents"
USER_AGENTS_DIR = "~/.Baleen/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("Baleen.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from Baleen.agents.parser import parse_frontmatter, _validate_agent_meta
