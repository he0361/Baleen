...
def build_teammate_tools(
    ...
    from Baleen.tools.send_message import SendMessageTool
    from Baleen.tools.task_create import TaskCreateTool
    from Baleen.tools.task_get import TaskGetTool
    from Baleen.tools.task_list import TaskListTool
    from Baleen.tools.task_update import TaskUpdateTool
