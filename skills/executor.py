...
from Baleen.skills.parser import SkillDef, substitute_arguments
from Baleen.tools import ToolRegistry

if TYPE_CHECKING:
    from Baleen.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from Baleen.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
