...
from Baleen.permissions.dangerous import DangerousCommandDetector, is_safe_command
from Baleen.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from Baleen.permissions.rules import RuleEngine, extract_content
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".Baleen/plans/" in target_path
        try:
