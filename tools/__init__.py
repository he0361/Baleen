...
from Baleen.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    from Baleen.tools.bash import Bash
    from Baleen.tools.edit_file import EditFile
    from Baleen.tools.file_state_cache import FileStateCache
    from Baleen.tools.glob import Glob
    from Baleen.tools.grep import Grep
    from Baleen.tools.read_file import ReadFile
    from Baleen.tools.write_file import WriteFile
