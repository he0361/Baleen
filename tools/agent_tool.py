...
from Baleen.tools.base import Tool, ToolResult
...
if TYPE_CHECKING:
    ...
    from Baleen.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from Baleen.agents.fork import ForkError, build_forked_messages
        from Baleen.agents.parser import AgentDef
        from Baleen.agents.tool_filter import resolve_agent_tools
        from Baleen.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from Baleen.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from Baleen.agents.fork import ForkError, build_forked_messages
        from Baleen.agents.parser import AgentDef
        from Baleen.agents.tool_filter import build_teammate_tools
        from Baleen.agent import Agent as AgentClass
        from Baleen.conversation import ConversationManager
        from Baleen.permissions import (
            DangerousCommandDetector,
        ...
        from Baleen.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from Baleen.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from Baleen.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from Baleen.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from Baleen.client import create_client
