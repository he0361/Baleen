...
from Baleen.conversation import (
    ConversationManager,
    Message,
    ToolResultBlock,
    estimate_tokens,
)
from Baleen.serialization import build_messages
...
SESSION_SUBDIR = ".Baleen/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from Baleen.tools.base import StreamEnd, StreamEvent, TextDelta
